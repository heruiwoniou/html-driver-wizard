...
var CurrentSelection = /** @class */ (function () {
    ...
    CurrentSelection.prototype.render = function () {
        ...
        return this.current ? (h("div", { className: "ts-current-selection" },
            h("div", { className: "ts-selection-box", style: style }))) : (h("div", { className: "ts-current-selection" }));
    };
    return CurrentSelection;
}());
exports.default = CurrentSelection;
//# sourceMappingURL=current-selection.js.map